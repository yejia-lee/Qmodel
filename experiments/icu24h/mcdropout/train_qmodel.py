"""Threshold-specific FP-risk Q-model selection for ICU-24h (MC Dropout)."""
...
SUMMARY_CSV_NAME = "prob_thr_sweep_summary_mcdropout_icu24h_only_mask_trainQ_WITH_CALIBRATION.csv"
