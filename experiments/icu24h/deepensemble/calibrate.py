"""
cali_ensemble.py — Standalone calibration script for the Deep Ensemble base model.
...
and saves everything needed by qmodel_sweep_ensemble.py into a single
...
# ============================================================
# 1. Load & preprocess data (identical to qmodel sweep script for ensemble)
# ============================================================
print("\nLoading data...")
...
base_train_prob_icu = base_train_mean[base_train_mask, ICU24H_IDX]
base_train_true_icu = base_train_labels[base_train_mask, ICU24H_IDX].astype(int)
...
diag_path = os.path.join(CSV_DIR, "calibration_diagnostics_ensemble_train_test.csv")
pd.DataFrame([{
...
# ============================================================
# 5. Save everything qmodel_sweep_ensemble.py needs
# ============================================================
np.savez(
    NPZ_OUT,
