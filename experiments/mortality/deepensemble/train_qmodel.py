"""
qmodel_sweep_ensemble_mortality365d.py — Q-model prob_threshold sweep for
Deep Ensemble (365d mortality), using calibrated probabilities produced
by cali_ensemble_mortality365d.py
(loaded from calibrated_probs_ensemble_mortality365d.npz). Does NOT
reload the pretrained ensemble members or rerun inference.
...
# mortality_365d Deep Ensemble threshold observed ~0.136 (val sens=0.80)
...
# ============================================================
# 1. Load calibrated probabilities + ensemble stats from cali_ensemble_mortality365d.py
# ============================================================
...
#    cali_ensemble_mortality365d.py (feature reconstruction only —
...
summary_path = os.path.join(CSV_DIR, "prob_thr_sweep_summary_ensemble_mortality365d_only_mask_trainQ_WITH_CALIBRATION.csv")
