"""Threshold-specific FP-risk Q-model selection for 365d Mortality (BasicMLP)."""
...
SUMMARY_CSV_NAME = "prob_thr_sweep_summary_basicmlp_mortality365d_only_mask_trainQ_WITH_CALIBRATION.csv"
