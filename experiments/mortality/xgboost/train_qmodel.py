"""Threshold-specific FP-risk Q-model selection for 365d Mortality (XGBoost)."""
...
SUMMARY_CSV_NAME = "prob_thr_sweep_summary_xgboost_mortality365d_withmask_trainQ_WITH_CALIBRATION.csv"
